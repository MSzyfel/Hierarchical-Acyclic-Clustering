\begin{figure}[H]
    ...
    \begin{minipage}[c][8.3cm][c]{0.28\textwidth}
        \centering
        \begin{tikzpicture}[scale=1.12,every node/.style={circle,draw,fill=white,inner sep=1.4pt,font=\small,preaction={fill=black,opacity=0.18,transform canvas={xshift=0.8pt,yshift=-0.8pt}}}]
            \node (a) at (0.0,1.4) {$a$};
            \node (b) at (-1.7,0.4) {$b$};
            \node (c) at (-1.0,-1.3) {$c$};
            \node (d) at (1.1,-1.2) {$d$};
    ...
    \begin{minipage}[c][8.3cm][c]{0.68\textwidth}
        ...
        \begin{tikzpicture}[
            ...
            base/.style={circle,draw,fill=white,inner sep=1.2pt,font=\scriptsize,preaction={fill=black,opacity=0.18,transform canvas={xshift=0.8pt,yshift=-0.8pt}}},
            tnode/.style={circle,draw=cutD,fill=white,inner sep=1.1pt,font=\scriptsize,transform shape=false,preaction={fill=black,opacity=0.18,transform canvas={xshift=0.8pt,yshift=-0.8pt}}},
