...
\While{$c\br{U, V'\setminus U} > \frac{1}{\tilde r}\ln\!\left(\frac{\operatorname{vol}(v,\tilde r)}{\operatorname{vol}(v,0)}\right)\cdot \operatorname{vol}\br{v,\dist_{d,V'}\br{v,v_0}}$}{
	$U\gets U\cup\{v_0\}$\;
	Set $v_0\gets$ closest vertex to $U$ in $V'\setminus U$ with respect to $\dist_{d,V'}$\;
}
\Return{$U$}\;
